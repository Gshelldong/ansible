...
--
-- Current Database: `jp_db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `jp_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `article` VALUES (1,NULL,NULL,'欢迎使用JPress','<p>欢迎使用 JPress，这是一篇 JPress 自动为您创建的测试文章，您可以进入 JPress 的后台，在文章管理里进行修改或者删除。</p>','html',NULL,NULL,NULL,NULL,1,0,'normal',1,0,NULL,5,'2019-09-02 11:42:02','2019-09-02 11:44:26',NULL,NULL,NULL,NULL),(2,NULL,NULL,'ansible一键完成lnmp架构','<p><span style=\"font-size:24px\">继续对来自或途经国内疫情中高风险地区的来沪返沪人员加强管理。 一、所有来自或途经国内疫情中高风险地区的来沪返沪人员，应在抵沪后的12小时内向所在社区居村委和单位（或所住宾馆）报告。</span></p>\n\n<p><span style=\"font-size:24px\"><img alt=\"\" src=\"/attachment/20200623/b1d22f02207f4bd3a73f313e53f2bde8.png\" /></span></p>\n','html',NULL,NULL,NULL,NULL,1,0,'normal',1,0,NULL,4,'2020-06-23 10:57:58','2020-06-23 10:57:58',NULL,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='附件表，用于保存用户上传的附件内容。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `attachment` VALUES (1,1,'1.png',NULL,'/attachment/20200623/b1d22f02207f4bd3a73f313e53f2bde8.png','image/png','.png',NULL,NULL,0,1,'2020-06-23 10:57:40',NULL),(2,1,'Snipaste_2017-11-21_09-50-36.png',NULL,'/attachment/20200623/edf07bc7dd994375b94b0bc152cc6965.png','image/png','.png',NULL,NULL,0,1,'2020-06-23 11:25:04',NULL);
...
--
-- Table structure for table `coupon_used_record`
--
...
--
-- Dumping data for table `coupon_used_record`
--

LOCK TABLES `coupon_used_record` WRITE;
/*!40000 ALTER TABLE `coupon_used_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `coupon_used_record` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `member_dist_amount`
--
...
--
-- Dumping data for table `member_dist_amount`
--

LOCK TABLES `member_dist_amount` WRITE;
/*!40000 ALTER TABLE `member_dist_amount` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_dist_amount` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `member_joined_record`
--
...
--
-- Dumping data for table `member_joined_record`
--

LOCK TABLES `member_joined_record` WRITE;
/*!40000 ALTER TABLE `member_joined_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_joined_record` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `member_price` WRITE;
/*!40000 ALTER TABLE `member_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_price` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='配置信息表，用来保存网站的所有配置信息。';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `option` VALUES (1,'web_name','晓东的网页'),(2,'web_title','Sheldon'),(3,'web_subtitle','小东'),(4,'jpress_version','v3.2.5'),(5,'jpress_version_code','25');
...
INSERT INTO `role` VALUES (1,'默认角色','这个是系统自动创建的默认角色','jpsa','2020-06-23 10:54:25','2020-06-23 10:54:25');
...
--
-- Table structure for table `single_page_comment`
--
...
--
-- Dumping data for table `single_page_comment`
--

LOCK TABLES `single_page_comment` WRITE;
/*!40000 ALTER TABLE `single_page_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `single_page_comment` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (1,'admin','admin','admin',NULL,'f42d833fbb532928de5a264a367adfde59d784610f4a94645ca99a1570f71fdd','mxY4ZF7pq7Sb5WvMFleZwFbMMpiqV04a',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'ok','2020-06-23 10:54:25','web_register','2020-06-23 11:23:38','2020-06-23 10:54:25');
...
--
-- Table structure for table `user_amount_payout`
--
...
--
-- Dumping data for table `user_amount_payout`
--

LOCK TABLES `user_amount_payout` WRITE;
/*!40000 ALTER TABLE `user_amount_payout` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_amount_payout` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_amount_statement`
--
...
--
-- Dumping data for table `user_amount_statement`
--

LOCK TABLES `user_amount_statement` WRITE;
/*!40000 ALTER TABLE `user_amount_statement` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_amount_statement` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `user_order_delivery`
--
...
--
-- Dumping data for table `user_order_delivery`
--

LOCK TABLES `user_order_delivery` WRITE;
/*!40000 ALTER TABLE `user_order_delivery` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_order_delivery` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_order_invoice`
--
...
--
-- Dumping data for table `user_order_invoice`
--

LOCK TABLES `user_order_invoice` WRITE;
/*!40000 ALTER TABLE `user_order_invoice` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_order_invoice` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `user_tag_mapping`
--
...
--
-- Dumping data for table `user_tag_mapping`
--

LOCK TABLES `user_tag_mapping` WRITE;
/*!40000 ALTER TABLE `user_tag_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_tag_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `utm` VALUES ('059cf90fe5aa43289e87a42ea1fe273d',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:16:16'),('08423488bfa34f7f994cb792e5f84b7d',NULL,NULL,'/commons/captcha','d=0.37348328274813003',NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:20:59'),('0e11f4b1529f452d84003eeb226e291d',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:33:01'),('1098efd3755b4003a7c6766dc58d550d',NULL,NULL,'/admin',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:23:22'),('11e6db8b3d04499ab379bfc0d51c1922',NULL,NULL,'/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:20:36'),('14c2e078e038454a86f12bbe6f79aa65',1,NULL,'/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:24:33'),('20bdd131b4bd4851b04166e1dbf784c1',NULL,NULL,'/login',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:22:44'),('3312633af2f6439f961cbe72d7a41204',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:26'),('3d2d8c7c9f9341d490abf3608008cc83',1,NULL,'/admin/article/write',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/admin/index',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:23:47'),('4e2cfc110c264583acddfa1fcd177788',NULL,NULL,'/commons/captcha','d=0.6860283033336061',NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:20:46'),('53d54ef90cf54b7a9aa3fb4b609759c7',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:22:48'),('65edbe13719e4d74a789f0b458154fb8',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:26'),('675d9ced2e3e47ad9c491a24fcb39227',NULL,NULL,'/login',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:22:42'),('73000911d9794e4b811ec4dfa8d8176a',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:26'),('731c315f80af401f90802507046956a4',1,NULL,'/commons/captcha',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:24:33'),('7d5fd21baaaa4b1190204a25febf1636',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:27'),('838dbae689fe4552bcf4599ff0b907ad',NULL,NULL,'/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:20:37'),('8cf5a0fb7136438f87a1ad6de401d7e7',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:27'),('998a8529646047389ae80c59e8b98f92',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:22:27'),('9d438800130542479d03f07d9fe2a787',NULL,NULL,'/article/postComment',NULL,NULL,NULL,NULL,NULL,'adfafd',NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:20:56'),('b77ecc5238cc48ca8224fcab4ab59742',NULL,NULL,'/article/postComment',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:20:44'),('b9c93b01a7d244428ebc717423374f9a',1,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/admin/article/write',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:24:30'),('c47d652dd9364618a62c83a9e6248378',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:25'),('c940231cd87f43b296e7a1d2e519d705',1,NULL,'/commons/ckeditor/upload',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/admin/article/write',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:25:04'),('d04fe1ca5a7349dbb72b906b42e81dbc',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:39'),('d13e8b2cfd7645ff97ea09d2c609c4aa',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:20:31'),('d7f5b26ea8dd4653b5aec737d5403e33',NULL,NULL,'/admin/index',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/admin/login',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:23:38'),('dce9e2cfe1c44e888d975994b84c6684',NULL,NULL,'/commons/captcha',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/admin/login',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:23:22'),('deba613264594f64842432a62c505c03',NULL,NULL,'/commons/captcha',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36','http://jp.gong.com:8080/article/2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:20:39'),('ed0c4478d6124956bf72ab3b9b680b8e',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:26'),('ff6d2ca661a6480492a847026d390b0b',NULL,NULL,'/',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'10.0.0.211','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-06-23 11:45:27');
...
INSERT INTO `db` VALUES ('%','test','','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','N','N','Y','Y'),('%','test\\_%','','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','N','N','Y','Y'),('%','jp_db','jp','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y');
...
LOCK TABLES `user` WRITE;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` VALUES ('localhost','root','*23AE809DDACAF96AF0FD78ED04B6A265E05AA257','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('db01','root','','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('127.0.0.1','root','','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('::1','root','','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('localhost','','','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','','','','',0,0,0,0,'',''),('db01','','','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','','','','',0,0,0,0,'',''),('%','zh','*23AE809DDACAF96AF0FD78ED04B6A265E05AA257','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('%','wp','*23AE809DDACAF96AF0FD78ED04B6A265E05AA257','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,'',''),('%','rep','*23AE809DDACAF96AF0FD78ED04B6A265E05AA257','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','','','','',0,0,0,0,'',''),('%','jp','*23AE809DDACAF96AF0FD78ED04B6A265E05AA257','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','','','','',0,0,0,0,'','');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-06-23 11:53:10
